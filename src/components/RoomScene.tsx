...
const RoomScene: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (canvasRef.current) {
      ...
      window.addEventListener('roomLoadingProgress', handleProgress as EventListener);
      window.addEventListener('roomLoadingComplete', handleLoadComplete);
      
      // Cleanup
      return () => {
        window.removeEventListener('roomLoadingProgress', handleProgress as EventListener);
